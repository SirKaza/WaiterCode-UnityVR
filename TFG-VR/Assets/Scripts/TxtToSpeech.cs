...
public class TxtToSpeech : MonoBehaviour
{
    ...
    private const string SubscriptionKey = "ad021b77376b421197a6679f75431652";
    ...
    public void Play(string texts)
    {
        ...
        using (var result = synthesizer.StartSpeakingTextAsync(texts).Result)
        {
